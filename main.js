...
<header>
  <nav class="top-nav">
    <img src="logo.png" alt="Logo ANSAR ALMOUYASSAR" class="logo">
...
<section id="home" class="page active">
  ...
  <div class="header" style="background-image: url('photo1.png');">
    ...
    <div class="ad-banner">
      <div class="ad-text banner-text">
        ...
        <p>Association des ressortissants de l'institut Al Mouyassar</p>
      </div>
    </div>
  </div>
...
<div class="grid">
  <!-- 4 Boutons RONDS en haut -->
  <div class="item circle-item" onclick="showPage('events')">
    <i class="fas fa-calendar-alt icon"></i>
    <span class="item-text">Événements</span>
  </div>
  <div class="item circle-item" onclick="showPage('quibla')">
    <i class="fas fa-compass icon"></i>
    <span class="item-text">Quibla</span>
  </div>
  <div class="item circle-item" onclick="showPage('quizz')">
    <i class="fas fa-question-circle icon"></i>
    <span class="item-text">Quiz</span>
  </div>
  <div class="item circle-item" onclick="showPage('tasbih')">
    <i class="fas fa-circle-notch icon"></i>
    <span class="item-text">Tasbih</span>
  </div>

  <!-- 6 Boutons RECTANGULAIRES en bas -->
 <div class="item" onclick="showPage('priere')">
    <span class="item-text">Prière</span>
    <i class="fas fa-person-praying icon"></i> 
  </div>
  <div class="item" onclick="showPage('coran')">
    <span class="item-text">Coran</span>
    <i class="fas fa-quran icon"></i>
  </div>
  <div class="item" onclick="showPage('hadith')">
    <span class="item-text">Hadith</span>
    <i class="fas fa-book icon"></i>
  </div>
  <div class="item" onclick="showPage('library')">
    <span class="item-text">Bibliothèque</span>
    <i class="fas fa-book-open icon"></i>
  </div>
  <div class="item" onclick="showPage('projet')">
    <span class="item-text">Projets Ansar</span>
    <i class="fas fa-rocket icon"></i>
  </div>
  <div class="item" onclick="showPage('members')">
    <span class="item-text">Membres</span>
...
<section id="projet" class="page">
  ...
  <div class="projet-container">
    ...
    <header class="projet-header">
      <h1>Ansar Projet</h1>
<h2>Promotion & financement de vos projets</h2>
        <p>Cliquer sur le bouton pour commencer</p>
    </header>

    <!-- Main Buttons -->
    <div class="projet-buttons">
       <button onclick="showProjetSection('promotion')" class="projet-btn bg-blue"> Préparer mon dossier .    
...
<section id="settings" class="page">
  ...
  <div class="links-container">
    ...
    <a href="https://ahmedaidara.github.io/qibla" target="_blank" class="link-button">
      Cours en ligne
    </a>
    ...
    <a href="https://ahmedaidara.github.io/ansar1.0/privacy-policy.html" target="_blank" class="link-button">
      ...
      <a href="https://ahmedaidara.github.io/ansar1.0/soutenir.html" target="_blank" class="link-button">
    Nous soutenir
  </a>

  </div>
  <!-- Nouveau lien d'aide ajouté ici -->
  <div style="text-align: center; margin-top: 20px;">
    <a href="https://ahmedaidara.github.io/aideansar" target="_blank" style="color: #3498db; text-decoration: none; font-size: 16px;">
      Aide & Support
    </a>
  </div>
</section>
...
function handleExternalLinks() {
  // Sélectionne tous les liens dans les sections concernées
  const links = document.querySelectorAll('#settings a[href^="http"], .business-modal a[href^="http"]');
  ...
  links.forEach(link => {
    link.addEventListener('click', function(e) {
      ...
      // Solution spécifique pour Kodular
      try {
        // Essayer d'ouvrir via l'API Android de Kodular
...
// Exécuter au chargement et après chaque changement de page
document.addEventListener('DOMContentLoaded', handleExternalLinks);

// Si vous avez une fonction showPage(), modifiez-la pour déclencher handleExternalLinks
const originalShowPage = showPage;
showPage = function(page) {
  originalShowPage.apply(this, arguments);
  setTimeout(handleExternalLinks, 300); // Petit délai pour laisser le DOM se mettre à jour
};
</script>
<script>
function downloadPDF(url) {
  try {
    // Pour Kodular
    if (window.android) {
      window.android.openBrowser(url); // Ouvre dans le navigateur où le téléchargement peut se faire
      return;
    }
...
// <img src="cover.jpg" onclick="downloadPDF('book.pdf')">
</script>
</body>
  <script>
