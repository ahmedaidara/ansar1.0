...
},
{
    ...
    response: "Visitez notre site web, le lien est disponible dans la page parametre"
},
{
    keywords: ["politique", "confidentialité", "confidentialite"],
    response: "Consultez notre politique de confidentialité dans la page parametre"
},
{
